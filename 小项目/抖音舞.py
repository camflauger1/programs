...
pixels = r".,-'`:!1+*abcdefghijklmnopqrstuvwxyz<>()\/{}[]?234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ%&@#$"
...
def play_video(video_chars):
    ...
    for pic_i in range(len(video_chars)):
        ...
        time.sleep(1 / 90)  # 粗略地控制播放速度。

        subprocess.call("cls")  # 调用shell命令清屏，用 cmd 的话要把 "clear"改成 "cls"


if __name__ == "__main__":
    imgs = video2imgs(r"F:\python\Python36-32\programs\小项目\视频资源\1.mp4", (80, 60))
